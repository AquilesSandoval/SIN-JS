function confirmDelete(key, token){
        alertify.confirm('Confirmación', 'Seguro que desea eliminar el registro', 
            function(){
                $.ajax({
                     type: 'POST',
                     url: "index.php?r=drillsfolder/delete",
...
jQuery(function ($) {
jQuery('#w0').yiiGridView({"filterUrl":"\/web\/index.php?r=drillsfolder\/index","filterSelector":"#w0-filters input, #w0-filters select","filterOnFocusOut":true});
});
